...
saveRDS(resultados_f1, "actividad_3/resultados/f1_adaptativo_local_search.RDS")
...
saveRDS(resultados_f2, "actividad_3/resultados/f2_adaptativo_local_search.RDS")
...
saveRDS(resultados_f3, "actividad_3/resultados/f_adaptativo_local_search.RDS")
...
saveRDS(resultados_f4, "actividad_3/resultados/f4_adaptativo_local_search.RDS")
...
saveRDS(resultados_f5, "actividad_3/resultados/f5_adaptativo_local_search.RDS")
...
saveRDS(resultados_f6, "actividad_3/resultados/f6_adaptativo_local_search.RDS")
